    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // вместо того, что в скобочках нужно ввести значения из бд
                //saNames[0, 0] = "John";
                //saNames[0, 1] = "Smith";
                //saNames[1, 0] = "Tom";
                //saNames[1, 1] = "Brown";
                ...
                // далее я пишу, как примерно будет выглядеть твой кодик))
                ...
                oSheet.get_Range("A2", "E101").Value2 = saNames;
